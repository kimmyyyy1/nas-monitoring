...
<head>
    ...
    <style>
        ...
        form { padding: 0; }
        /* Ang form na ito ay simple lang, kaya 2-column grid */
                ...
                <div class="form-column">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="male_count" id="male_count" value="0" required>
                        </div>
                        <div class="form-group">
                            <label for="female_count">Female Count:</label>
                            <input type="number" name="female_count" id="female_count" value="0" required>
                        </div>
                        ...
                        <script>
                            ...
                            const myChart = new Chart(ctx, {
                                ...
                                data: { 
                                    ...
                                    datasets: chartData.datasets // [ {label: 'Male', ...}, {label: 'Female', ...} ]
                                },
                                options: {
                                    responsive: true,
                                    plugins: { 
                                    ...
                                    scales: { 
                                        x: { 
                                            stacked: true // Ito ang gagawing STACKED bar chart
                                        },
                                        y: { 
                                            stacked: true,
                                            beginAtZero: true, 

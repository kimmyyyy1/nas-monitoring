            ...
            <div class="page-container">
                ...
                <div class="form-column">
                    <div class="form-grid">
                        ...
                        <h3 class="grid-header">Initial Enrollment (SY 2023-2024)</h3>
                        <div class="form-group"><label for="initial_enrollment_male">Male Count:</label><input type="number" name="initial_enrollment_male" id="initial_enrollment_male" value="0" required></div>
                        <div class="form-group"><label for="initial_enrollment_female">Female Count:</label><input type="number" name="initial_enrollment_female" id="initial_enrollment_female" value="0" required></div>
                        <h3 class="grid-header">Transfer</h3>
                        <div class="form-group"><label for="transfer_male">Male Count:</label><input type="number" name="transfer_male" id="transfer_male" value="0" required></div>
                        <div class="form-group"><label for="transfer_female">Female Count:</label><input type="number" name="transfer_female" id="transfer_female" value="0" required></div>
                        <h3 class="grid-header">Dropped</h3>
                        <div class="form-group"><label for="dropped_male">Male Count:</label><input type="number" name="dropped_male" id="dropped_male" value="0" required></div>
                        <div class="form-group"><label for="dropped_female">Female Count:</label><input type="number" name="dropped_female" id="dropped_female" value="0" required></div>
                        <h3 class="grid-header">Projected Enrollees for Next SY</h3>
                        <div class="form-group"><label for="projected_enrollees_male">Male Count:</label><input type="number" name="projected_enrollees_male" id="projected_enrollees_male" value="0" required></div>
                        <div class="form-group"><label for="projected_enrollees_female">Female Count:</label><input type="number" name="projected_enrollees_female" id="projected_enrollees_female" value="0" required></div>
                    </div>
                </div>
                        ...
                        <script>
                            ...
                            const myChart = new Chart(ctx, {
                                ...
                                options: {
                                    ...
                                    scales: {
                                        x: { 
                                            stacked: true // Ito ang nagpapatong sa kanila
                                        }, 
                                        y: { 
                                            stacked: true, 
                                            beginAtZero: true, 
